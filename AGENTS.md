...
8. Change shared design tokens, theme layers, and reusable components before patching individual pages.
9. Finish with a consistency pass covering typography, spacing, surfaces, states, responsiveness, and accessibility.

Treat `$design-md-ui` as the default design reference skill for all repositories, not a repo-specific convention.
