...
- Industry App Center: packaged industry bundles, custom workspace builder, scenario-based desktop setup
- Solutions Hub: mature use-case mapping expanded into installable app workflows
- Multi-language UX: top-level language switcher and first-launch language selection
- New packaged apps:
  - Recruiting Desk
  - Project Ops Board
  - Deep Research Hub
...
- Workspace presets expanded for creator, sales, support, research, operations, personal, and language learning scenarios
