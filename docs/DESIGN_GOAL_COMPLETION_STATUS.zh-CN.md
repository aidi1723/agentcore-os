...
| playbook lifecycle 仍未产品化 | 当前已有 status/owner/review/changePolicy 和本地复审诊断，但还没有完整 authoring UI、版本迁移和 deprecation flow。 | 下一阶段扩展 authoring/versioning/deprecation workflow。 |
