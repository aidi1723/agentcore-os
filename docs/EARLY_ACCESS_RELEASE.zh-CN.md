...
- 当前推荐公开版本：`v1.2.0`
- 中文版本说明：`docs/releases/v1.2.0.zh-CN.md`
- GitHub / CNB 发布正文：`docs/releases/v1.2.0-github-release.zh-CN.md`
...
> AgentCore OS 是一个本地优先、面向真实工作的 AI 工作底座，支持在个人与企业场景下将模型、文件、工具、审批和工作流资产连接起来。当前推荐体验版本为 `v1.2.0`，推荐通过命令行方式安装和运行。
