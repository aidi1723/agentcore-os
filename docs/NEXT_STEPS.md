...
- Define rollback evidence and committed fixture replacement handoff next.
- Next concrete gap: committed fixture replacement handoff, so a reviewed candidate fixture cannot be treated as permission to replace committed fixture JSON without explicit replacement evidence and rollback notes.
