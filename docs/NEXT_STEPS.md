...
- Define rollback evidence and fixture refresh handoff next.
- Next concrete gap: fixture refresh handoff, so post-apply audit evidence can authorize fixture refresh review without publishing or claiming production readiness.
