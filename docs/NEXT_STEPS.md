...
- Define post-replacement fixture evidence validation next.
- Next concrete gap: post-replacement evidence gate, so manual committed fixture replacement cannot be treated as publishable until governed fixture, fixture summary, controlled-runtime, core workflow, and diff evidence are recorded green.
