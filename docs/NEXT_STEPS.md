...
- Define rollback evidence and candidate fixture review validation next.
- Next concrete gap: candidate fixture review validation, so a generated candidate fixture can be reviewed and rejected or accepted before any committed fixture replacement.
