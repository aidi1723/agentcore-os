    ...
    >
      <div className="relative bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="space-y-6 border-b border-gray-200 p-6 md:border-b-0 md:border-r">
            <h2 className="text-base font-semibold text-gray-900">素材与指令区</h2>
            ...
            <div
              className={[
                "rounded-xl border border-dashed p-6 transition-all cursor-pointer",
                isDragging
            ...
            <div>
              <label htmlFor="instruction-input" className="mb-2 block text-sm font-medium text-gray-700">
                指令
              </label>
              <Textarea
          ...
          <div className="p-6 space-y-6">
            <h2 className="text-base font-semibold text-gray-900">产出成果区</h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <Card padding="sm">
                <div className="bg-gray-900 h-56 flex items-center justify-center relative rounded-t-xl overflow-hidden">
                  {isSubmitting ? (
              ...
              <Card padding="sm">
                <div className="bg-gray-50 h-56 flex items-center justify-center relative rounded-t-xl overflow-hidden">
                  {isSubmitting ? (
                    <div className="absolute inset-0 animate-pulse">
