      ...
      <div className="relative bg-white">
        ...
        <div className="border-b border-gray-200 p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <h1 className="text-xl font-bold text-gray-900">Lead Qualification / Deal Desk</h1>
                  ...
                  <div className="space-y-2 pt-2">
                    {deals.length > 0 ? (
                      ...
                      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
                        <p className="text-sm text-gray-500">还没有线索</p>
                        <p className="mt-1 text-xs text-gray-400">点击上方「新建」按钮创建</p>
                      </div>
                    )}
                  </div>
                </CardBody>
                ...
                {selected ? (
                    ...
                    <CardBody spacing="md">
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="h-10 w-full rounded-xl border border-gray-300 bg-white px-4 text-sm text-gray-900 transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          >
                        ...
                        <Input
                          ...
                          placeholder="例如：USD 28,000 - 35,000"
                          fullWidth
                        />
                        <Input
                          label="时间"
                      ...
                      <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
                        ...
                        <div className="mt-3 grid gap-3 text-sm md:grid-cols-3">
                          <div>
                            <div className="text-xs font-semibold text-blue-600">来源</div>
                            <div className="mt-1 text-blue-900">
                              {selected.inquiryChannel || "待补充"}
                            </div>
                          </div>
                          <div>
                            <div className="text-xs font-semibold text-blue-600">产品线</div>
                            <div className="mt-1 text-blue-900">
                              {selected.productLine || "待补充"}
                            </div>
                          </div>
                          <div>
                            <div className="text-xs font-semibold text-blue-600">语言偏好</div>
                            <div className="mt-1 text-blue-900">
                              {selected.preferredLanguage || "待补充"}
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex min-h-[280px] items-center justify-center">
                    <div className="text-center">
                      <p className="text-sm text-gray-500">先创建或选择一条线索</p>
                      <Button
                        variant="primary"
                        size="md"
                        icon={<Plus className="h-4 w-4" />}
              ...
              <Card padding="md">
                ...
                <CardBody spacing="md">
                  ...
                  {selected?.brief ? (
                    ...
                    <div className="flex min-h-[240px] items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50">
                      <p className="text-sm text-gray-500">生成后，这里会出现线索判断简报</p>
                    </div>
                  )}
                  ...
                  {selected?.reviewNotes && (
                    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
                      ...
                      <pre className="mt-2 whitespace-pre-wrap font-sans text-sm leading-relaxed text-amber-950">
                        {selected.reviewNotes}
                      </pre>
                    </div>
                  )}
