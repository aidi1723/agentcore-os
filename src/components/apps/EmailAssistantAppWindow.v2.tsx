                  ...
                  <div className="space-y-2">
                    {threads.length > 0 ? (
                      ...
                      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 text-center">
                        <p className="text-sm text-gray-500">还没有邮件条目</p>
                ...
                {selected ? (
                  ...
                  <div className="flex min-h-[280px] items-center justify-center">
                    <div className="text-center">
                      <p className="text-sm text-gray-500">先创建或选择一个邮件条目</p>
                      <Button
                        variant="primary"
                        size="md"
                        icon={<Plus className="h-4 w-4" />}
              ...
              <Card padding="md">
                ...
                <CardBody spacing="md">
                  {selected?.draft ? (
                    ...
                    <div className="flex min-h-[280px] items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50">
                      <p className="text-sm text-gray-500">生成后，这里会出现邮件草稿</p>
                    </div>
                  )}
