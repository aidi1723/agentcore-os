      ...
      <div className="relative bg-white">
        ...
        <div className="border-b border-gray-200 p-6">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div>
              <h1 className="text-xl font-bold text-gray-900">Daily Operating Brief</h1>
                ...
                <CardBody>
                  <div className="min-h-[460px]">
                    ...
                    {brief ? (
                      ...
                      <div className="mt-4 flex min-h-[420px] items-center justify-center rounded-xl border border-dashed border-gray-300 bg-gray-50 text-sm text-gray-500">
                        生成后，这里会出现今日晨报。
                      </div>
                    )}
                  </div>
