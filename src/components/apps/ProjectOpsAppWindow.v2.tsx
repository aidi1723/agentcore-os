      ...
      <div className="relative bg-white">
        ...
        <div className="border-b border-gray-200 p-4 sm:p-6">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div>
              <h1 className="text-lg font-bold text-gray-900">Project Ops Board</h1>
          ...
          <div className="space-y-4">
            <Card padding="lg">
              <CardBody spacing="md">
                ...
                <pre className="min-h-[360px] whitespace-pre-wrap rounded-3xl border border-gray-200 bg-white p-4 text-sm leading-7 text-gray-700">
