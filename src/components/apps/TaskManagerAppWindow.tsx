                      ...
                      <div className="flex items-center justify-between gap-4">
                        ...
                        {task.status === "running" ? (
                          <button
                            ...
                            className="shrink-0 inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-red-200 bg-red-50 text-xs font-semibold text-red-700 transition-colors hover:bg-red-100"
                            title="停止任务"
                          >
