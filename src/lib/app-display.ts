...
const appNames: Record<AppId, CopySet> = {
  ...
  runtime_console: { zh: "AgentCoreOS 运行时控制台", en: "AgentCoreOS Runtime Console", ja: "AgentCoreOSランタイムコンソール" },
  openclaw_console: { zh: "AgentCoreOS 运行时控制台", en: "AgentCoreOS Runtime Console", ja: "AgentCoreOSランタイムコンソール" },
