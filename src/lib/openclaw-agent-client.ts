...
export function buildOpenClawAgentRequest(
  ...
  return {
    ...
    executorBackend: settings.runtime.executorBackend,
    clawCodeBinaryPath: settings.runtime.clawCodeBinaryPath,
    clawCodeWorkspace: settings.runtime.clawCodeWorkspace,
    clawCodePermissionMode: settings.runtime.clawCodePermissionMode,
    systemPrompt,
    useSkills: true,
