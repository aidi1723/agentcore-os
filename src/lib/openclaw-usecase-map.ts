    ...
    apps: [
      {
        ...
        coverage: "partial",
        mappedApps: ["openclaw_console", "task_manager", "morning_brief"],
        workflowActions: [
          { type: "open_app", appId: "openclaw_console", label: "打开 OpenClaw Console" },
          { type: "open_app", appId: "task_manager", label: "打开 任务中心" },
      ...
      },
      {
        ...
        coverage: "partial",
        mappedApps: ["openclaw_console", "knowledge_vault", "task_manager"],
        workflowActions: [
          { type: "open_app", appId: "openclaw_console", label: "打开 OpenClaw Console" },
          { type: "open_app", appId: "knowledge_vault", label: "打开 知识库" },
          { type: "open_app", appId: "task_manager", label: "打开 任务中心" },
      ...
      },
      {
        ...
        coverage: "partial",
        mappedApps: ["openclaw_console", "morning_brief", "task_manager"],
        workflowActions: [
          { type: "open_app", appId: "openclaw_console", label: "打开 OpenClaw Console" },
          { type: "open_app", appId: "morning_brief", label: "打开 Morning Brief" },
          { type: "open_app", appId: "task_manager", label: "打开 任务中心" },
